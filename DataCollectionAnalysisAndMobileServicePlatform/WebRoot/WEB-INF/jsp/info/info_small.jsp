...
<script type="text/javascript">
	...
	$(function() {
		...
		try {
			$('#tbImportant').bootstrapTable({
				...
				url : "${pageContext.request.contextPath }/info/getsmall",//要请求数据的文件路径
				...
				columns : [ {
					...
					field : "dpRespUnitname",
					title : "单位名称",
				}, {
					field : "dpRespUnitaddress",
					title : "单位地址"
				}, {
					field : "dpRespLiable",
					title : "负责人姓名"
				} , {
					field : "dpRespLiablephone",
					title : "负责人电话"
				} ]
			});
		} catch (e) {
	...
	function refresh() {
		$('#tbImportant').bootstrapTable('refresh', {
			url : "${pageContext.request.contextPath }/info/getsmall"
		});
	}

...
<script type="text/javascript">
	...
	function createTable(d) {
		...
		tableHtml += '<th style="width: 10%;text-align: center;">登录名</th>';
		tableHtml += '<th style="width: 10%;text-align: center;">用户名</th>';
		tableHtml += '<th style="width: 20%;text-align: center;">所属单位</th>';
		tableHtml += '<th style="width: 20%;text-align: center;">权限组</th>';
		...
		for (var i = 0; i < d.length; i++) {
			...
			tableHtml += '<td><lable style="color:green;">一般用户</lable></td>';
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							用户权限设定<small style="float: right;"><a

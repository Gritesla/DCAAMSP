...
<script type="text/javascript">
		...
		try {
			$('#tbBasic').bootstrapTable({
				...
				columns : [ {
					...
					field : "dpRespPlanname",
					title : "预案名称",
				}, {
					field : "dpRespCompanyname",
					title : "单位名称"
				}, {
	...
	function refresh() {
		$('#tbImportant').bootstrapTable('refresh', {
			url : "${pageContext.request.contextPath }/plan/getbasic"
		});
	}

	function search() {
		$("#tbBasic").bootstrapTable("refreshOptions", {
			pageIndex : 1,
			pageSize : 10
		});
